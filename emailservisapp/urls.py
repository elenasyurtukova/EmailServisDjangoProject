...
urlpatterns = [
    ...
    path(
        "attempts/<int:pk>/", views.AttemptDetailView.as_view(), name="attempt_detail"
    ),
    path("attempts/create", views.AttemptCreateView.as_view(), name="attempt_create"),
    path(
        "attempts/<int:pk>/update",
        views.AttemptUpdateView.as_view(),
        name="attempt_update",
    ),
    path(
    ...
    path(
        "mailing/<int:pk>/send/", views.SendMailingView.as_view(), name="send_mailing"
    ),
